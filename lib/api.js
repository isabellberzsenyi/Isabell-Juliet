...
export async function getProjects() {
  ...
  return results.map((p) => {
    return {
      ...
      description: p.data.project_overview,
      codeLink: p.data.code_link,
      demoLink: p.data.demo_link,
      topics: p.data.project_topics,
      previewImage: p.data.project_preview_image,
    };
  });
}
